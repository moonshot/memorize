...
SECRET_KEY = 'i6o_2+b-%hj))$^fmo*-i)@g!kluur9)fs#$bvfvxu_d306*5l'
...
# The same string must be passed as a query param from the API request
API_KEY = 'foo'

# Django REST framework
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'passages.authz.ApiKeyAuthentication',
    ),
